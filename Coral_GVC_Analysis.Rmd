...
LD_stats <- read.csv("LDAll_19Sep17.csv", header = TRUE)
...
dark_dark <- subset(LD_stats, light.dark=="dark")
...
dark_cav <- subset(dark_dark, species=="Mcav")
dark_dun <- subset(dark_dark, coral=="dun")
